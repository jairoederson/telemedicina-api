...
<head>
    ...
    <title>Registrese | Bienvenido a Mifarma</title>
    <!--global css starts-->
    ...
    <div class="row">
        <div class="box animation flipInX">
          <a href="/">
            ...
            <h4 class="text-center" style="color: #9f9f9f">Crea tu cuenta aquí</h4>
            <!-- Notifications -->
            <div id="notific">
            ...
            <form action="{{ route('register') }}" method="POST" id="reg_form">
                ...
                <div id="s1" class="" style="display: block; text-align: center; color: #0000000">
                  <!-- <h5>Tipo de usuario</h5> -->
                  <input onkeyup="this.value = this.value.replace(/[&$*<>]/g, '')" type="checkbox" onclick="medico();" id="id-name--1" name="set-name" class="switch-input">
                  <label style="margin-bottom:0px" for="id-name--1" class="switch-label">
                    Usuario
                    <span class="toggle--on">Medico</span>
                    <span class="toggle--off">Paciente</span>
                  </label>
                </div>

                <div id="s2" class="" style="display: none; text-align: center">
                  <h5>Tipo de usuario</h5>
                  <input onkeyup="this.value = this.value.replace(/[&$*<>]/g, '')" type="checkbox" onclick="paciente();" id="id-name--1" name="set-name" class="switch-input">
                  <label for="id-name--1" class="switch-label">Usuario
                    <span class="toggle--on">Medico</span>
                    <span class="toggle--off">Paciente</span>
                  </label>
                </div>

                <input id="pacienteH" type="hidden" name="" value="Paciente">
                <input id="medicoH" type="hidden" name="" value="Medico">

                <div class="group form-group {{ $errors->first('name', 'has-error') }}">
                  <input onkeyup="this.value = this.value.replace(/[&$*<>]/g, '')" type="text" name="name" value="{!! old('name') !!}" required style="padding-right:0px">
                  <span class="highlight"></span>
                  <span class="bar"></span>
                  <label class="material">Nombres</label>
                  {!! $errors->first('name', '<span class="help-block">:message</span>') !!}
                </div>

                <div class="group form-group {{ $errors->first('ape_paterno', 'has-error') }}">
                    <input onkeyup="this.value = this.value.replace(/[&$*<>]/g, '')" type="text" name="ape_paterno" value="{!! old('ape_paterno') !!}" required>
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label class="material">Apellidos</label>
                    {!! $errors->first('ape_paterno', '<span class="help-block">:message</span>') !!}
                </div>

                <div class="group form-group" style="margin-top: 70px">
                    <input onkeyup="this.value = this.value.replace(/[&$*<>]/g, '')" type="text" name="dni">
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label class="material" style="color: #999">DNI</label>
                </div>

                <div id="cmp" class="group form-group" style="display: none;margin-top:35px">
                  <input onkeyup="this.value = this.value.replace(/[&$*<>]/g, '')" id="cmpField" type="text" name="cmp">
                  <span class="highlight"></span>
                  <span class="bar"></span>
                  <label class="material" style="color: #999">CMP</label>
                </div>

                <div id="specialty" class="group form-group" style="display: none;margin-top:35px">
                  <input onkeyup="this.value = this.value.replace(/[&$*<>]/g, '')" id="specialtyField" type="text" name="specialty">
                  <span class="highlight"></span>
                  <span class="bar"></span>
                  <label class="material" style="color: #999">Especialidad</label>
                </div>
                ...
                <div class="group form-group {{ $errors->first('password', 'has-error') }}">
                    <span id="icon-span" onclick="showPassword()" class="glyphicon glyphicon-eye-open icon-visibility" ><i class=""></i></span>
                ...
                <div class="group form-group {{ $errors->first('password_confirm', 'has-error') }}">
                    <span id="icon-span-rep" onclick="showPasswordRep()" class="glyphicon glyphicon-eye-open icon-visibility" ></span>
            ...
            <div>
                ...
                <div class="checkbox cb-padding-top cb-padding-bottom">
                    <label >
                        <input type="checkbox" name="subscribed" style="border: 1px solid">  Acepto los <a href="" data-toggle="modal" data-target="#term-condition" class="text-link-color"> Términos y Condiciones</a>
                    </label>
                </div>
                <!-- <input type="hidden" id="attempsR" name="attempsR" value="0"> -->
                <div class="center">
                  <div class="g-recaptcha" data-sitekey="6Lf5B0YUAAAAADoiUFizC-NMYd-OtAXgXEQqo9c-"></div>
                </div>
                <br>
                <button onclick="saveAttemppsR()" type="submit" class="btn btn-block btn-color" style="color: #ffffff">Registrarse</button>
                <br>
                  Si Ya tiene una cuenta. Por favor <a href="{{ route('login') }}" class="text-link-color"> Incie Sesion</a>
            </form>
        </div>
    </div>
    <!-- //Content Section End -->
        ...
        <div class="panel-body">
          <!-- <div class="box title-tc">
            <div class="row">
              ...
              <div class="col-md-2">
                <a href="" data-dismiss="modal" style="color: #FFFFFF">
                  <b>X</b>
                </a>
              </div>
            </div>
        ...
        <div class="panel-footer">
          <div class="modal-pie">
            <div class="text-right">
                <a href="/register"  class="btn bg-naranja" style="color: #ffffff;">Cancelar</a>
                &nbsp;
                <a href="/register" class="btn bg-verde" style="color: #ffffff;">Acepto</a>
            </div>
          </div>
        </div>
      </div>
