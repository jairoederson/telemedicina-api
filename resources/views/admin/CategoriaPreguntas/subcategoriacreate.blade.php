...
@section('content')
    <section class="content-header section-header">
        <div class="row">
            <div class="col-md-12">
                <h1 class="header-title">Actualizar Sub Categoria Pregunta</h1>
            </div>
        </div>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-12">
                                ...
                                <div class="form-group label-floating is-empty">
                                    ...
                                    <input onkeyup="this.value = this.value.replace(/[&$*<>]/g, '')" id="titulo" name="titulo" type="text" class="format-input input-format form-control" required value="">
                                </div>

                                <div class="form-group label-floating is-empty">
                                    <label class="control-label" for="direccion">Descripccion</label>
                                    <input onkeyup="this.value = this.value.replace(/[&$*<>]/g, '')" id="descripccion" name="descripccion" type="text" class="format-input input-format form-control" required >
                                </div>
                                <!--                            <div class="form-group label-floating is-empty">
    ...
    <script>
        ...
        function Registrar() {
            ...
            $.ajax({
                ...
                swal("Actualizado!", "Guardado Correctamente.", "success");
