...
<section class="content-header section-header">
    ...
    <div class="row">
        <div class="col-md-8">
            <h1 class="header-title">Categoria Pregunta </h1>
        </div>
        <div class="col-md-3">
            <div class="text-right" style="padding-top: 5px; padding-right: 5px">
                <a href="{{ URL::to('admin/categoria_preguntareg') }}"><button type="button" class="format btn btn-format">Agregar Categoria Pregunta</button></a>
            </div>
        </div>
    </div>
    ...
    $.ajax({
        ...
        jQuery.each(dataRpta, function (i, val) {
            ...
            val.acciones = `
                    ...
                    <button title='Editar' onclick="location.href='/admin/categoria_preguntaact/` + val.id +
...
function eliminarCategoria(id) {
    ...
    $.ajax({
        type: 'post',
        url: "{{ URL::to('admin/eliminarcategoria') }}",
        dataType: "json",
