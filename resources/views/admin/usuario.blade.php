...
<style>
    ...
    <div>
        ...
        <label class="control-label" for="name" ><a style="color:gray" href="{{ URL::to('admin/usuario/0') }}">Todos</a></label> 
            ...
            <label class="control-label" for="name"> | </label> 
            <label class="control-label" for="name"><a style="color:gray"  href="{{ URL::to('admin/usuario/2') }}">Medicos</a></label>
            <label class="control-label" for="name"> | </label> 
            <label class="control-label" for="name"><a style="color:gray"  href="{{ URL::to('admin/usuario/3') }}">Pacientes</a></label>
        <label class="control-label" for="name"> | </label>
        {{-- <label class="control-label" for="name"><a style="color:gray"  href="{{ URL::to('admin/usuario/6') }}">Enfermeros</a></label> --}}
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="text-right" style="padding-top: 5px; padding-right: 5px">
                        ...
                        <button type="button" class="format btn btn-format">Agregar Usuario</button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row medico-content">
                <div class="panel panel-primary" >
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered width100" width="100%" id="tableUsuario" >
                            <thead>
                                <tr class="filters">
...
<!--                                    <th>Ciudad</th>-->
    ...
    var urllistarusuario = "{{ URL::to('admin/listarusuario') }}";
    var token = '{{ csrf_token() }}';
    var eliminarusuarios = "{{ URL::to('admin/eliminarmedicos') }}";
