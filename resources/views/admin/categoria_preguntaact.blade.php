                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            ...
                            <div class="form-group label-floating is-empty">
                                ...
                                <input onkeyup="this.value = this.value.replace(/[&$*<>]/g, '')" id="titulo" name="titulo" type="text" class="format-input input-format form-control" required>
                            </div>
...
<script>
    ...
    function obtenerCategoria(id) {
        $.ajax({
            type: 'post',
            url: "{{ URL::to('admin/obtenercategoria') }}",
            dataType: "json",
            data: {
                idcategoria:id,
                '_token': '{{ csrf_token() }}'
    ...
    function Registrar() {
        ...
        $.ajax({
            type: 'post',
            url: "{{ URL::to('admin/registrarcategoria') }}",
            dataType: "json",
            data: {
                categoria: categoria,                
                '_token': '{{ csrf_token() }}'
