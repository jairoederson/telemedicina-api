...
<section class="content-header section-header">
    <div class="row">
        <div class="col-md-12">
            <h1 class="header-title">Actualización Inmunisaciones</h1>
        </div>
    </div>
...
<section class="content paddingleft_right15">
    <div class="row" style="margin-right: -30px;margin-left: -30px">
        <div class="panel panel-primary ">
            <form id="formRegistrarInmunisaciones">
                <fieldset>
                    <div class="col-md-12">
                        <div class="col-md-12">
...
<script>
    ...
    obtenerInmunisaciones('{!! $idinmunisaciones!!}');
    $("#formRegistrarInmunisaciones").submit(function () {
        ActualizarInmunisaciones();
        return false;
    });

    function ActualizarInmunisaciones() {
        ...
        $.ajax({
            type: 'post',
            url: "{{ URL::to('admin/modificarinmunisaciones') }}",
            dataType: "json",
            data: {
                inmunisaciones: oinmunisaciones,
                '_token': '{{ csrf_token() }}'
            },
    ...
    function obtenerInmunisaciones(idinmunisaciones) {
        $.ajax({
            type: 'post',
            url: "{{ URL::to('admin/obtenerinmunisaciones') }}",
            dataType: "json",
            data: {
                idinmunisaciones: idinmunisaciones,
                '_token': '{{ csrf_token() }}'
            },
            beforeSend: function (xhr) {
            }
            ...
            //alert(JSON.stringify(dataRpta));
            $('#nombre').val(dataRpta.inmunisaciones.name);
            $('#descripcion').val(dataRpta.inmunisaciones.description);
            $('#cmbDisease').val(dataRpta.inmunisaciones.diseas_id);
...
<!--<script type="text/javascript" src="{{ asset('assets/js/frontend/admin/registroInmunisaciones.js')}}"></script>-->
