...
<style>
    ...
    <style>
        ...
        <section class="content-header section-header">
            ...
            <div class="row">
                <div class="col-md-9">
                    <h4 class="header-title">General sed</h4>
                </div>

                <div class="col-md-3">
                    <div class="text-right" style="padding-top: 5px; padding-right: 5px">
                        <a href="{{ URL::to('admin/registrosed') }}">
                        <button type="button" class="format btn btn-format">Agregar sed</button></a>
                    </div>
                </div>
            </div>
        ...
        <section class="content">
            <div class="row sed-content">
                <div class="panel panel-primary" >
                    <br>
                    <div class="panel-body" style="padding-top: 0px !important;">
                    <div class="table-responsive">
                        <table class="table table-bordered width100" width="100%" id="tablesed" >
                            <thead>
                                <tr class="filters">
                                    <th>Nombre</th>
                                    <th>Descripcion</th>
    ...
    <script type="text/javascript" src="{{ asset('assets/js/frontend/admin/sed.js')}}"></script>
        <script src="{{ asset('assets/vendors/sweetalert/js/sweetalert.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/vendors/sweetalert/js/sweetalert-dev.js') }}" type="text/javascript"></script>
    <script type="text/javascript">

    var urllistarsed = "{{ URL::to('admin/listarsed') }}";
    var token = '{{ csrf_token() }}';
    var eliminarsed = "{{ URL::to('admin/eliminarsed') }}";
    listarsed();
