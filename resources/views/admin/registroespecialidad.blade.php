...
<section class="content-header section-header">
    <div class="row">
        <div class="col-md-12">
            <h1 class="header-title">Registro Especialidades</h1>
        </div>
    </div>
...
<script>
   var registrarEspecialidad = "{{ URL::to('admin/registroEspecialidad') }}";
...
<script type="text/javascript" src="{{ asset('assets/js/frontend/admin/registroEspecialidad.js')}}"></script>
