...
<section class="content-header section-header">
    <div class="row">
        <div class="col-md-12">
            <h1 class="header-title">Registro Prenatal</h1>
        </div>
    </div>
    ...
    <div class="row" style="margin-right: -30px;margin-left: -30px">
        <div class="panel panel-primary ">
            ...
            <fieldset>
                <div class="col-md-12">
                    <div class="col-md-12">
                        <div id="prenatalistema" class="panelcambio" style="display: block">
...
<script>
    ...
    var registrarPrenatal = "{{ URL::to('admin/registrarPrenatal') }}";
