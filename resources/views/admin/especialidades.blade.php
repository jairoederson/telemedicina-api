...
<style>
    ...
    <style>
        ...
        <section class="content-header section-header">
            ...
            <div class="row">
                <div class="col-md-9">
                    <h4 class="header-title">Especialidades</h4>
                </div>

                <div class="col-md-3">
                    <div class="text-right" style="padding-top: 5px; padding-right: 5px">
                        <a href="{{ URL::to('admin/registrarespecialidad') }}">
                        <button type="button" class="format btn btn-format">Agregar Especialidad</button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row medico-content">
                <div class="panel panel-primary" >
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered width100" width="100%" id="tableEspecialidades" >
                            <thead>
                                <tr class="filters">
                                    <th>Id</th>
                                    <th>Nombres</th>
    ...
    <script type="text/javascript" src="{{ asset('assets/js/frontend/admin/especialidad.js')}}"></script>
        <script src="{{ asset('assets/vendors/sweetalert/js/sweetalert.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('assets/vendors/sweetalert/js/sweetalert-dev.js') }}" type="text/javascript"></script>
    <script type="text/javascript">

        var urllistarespecialidad = "{{ URL::to('admin/listarespecialidad') }}";
    var token = '{{ csrf_token() }}';
    var eliminarespecialidad = "{{ URL::to('admin/eliminarespecialidad') }}";
