...
<section class="content-header section-header">
    <div class="row">
        <div class="col-md-12">
            <h1 class="header-title">Actualización Nacimientos</h1>
        </div>
    </div>
...
<section class="content paddingleft_right15">
    <div class="row" style="margin-right: -30px;margin-left: -30px">
        <div class="panel panel-primary ">
            <form id="formRegistrarNacimiento">
                <fieldset>
                    <div class="col-md-12">
                        <div class="col-md-12">
...
<script>
    ...
    obtenerNacimiento('{!! $idnacimiento!!}');
    $("#formRegistrarNacimiento").submit(function () {
        ActualizarNacimiento();
        return false;
    });

    function ActualizarNacimiento() {
        ...
        $.ajax({
            type: 'post',
            url: "{{ URL::to('admin/modificarnacimiento') }}",
            dataType: "json",
            data: {
    ...
    function obtenerNacimiento(idnacimiento) {
        $.ajax({
            type: 'post',
            url: "{{ URL::to('admin/obtenernacimiento') }}",
            dataType: "json",
            data: {
            ...
            //alert(JSON.stringify(dataRpta));
            $('#nombre').val(dataRpta.nacimiento.name);
            $('#descripcion').val(dataRpta.nacimiento.description);
            $('#cmbDisease').val(dataRpta.nacimiento.diseas_id);
...
<!--<script type="text/javascript" src="{{ asset('assets/js/frontend/admin/registroNacimiento.js')}}"></script>-->
