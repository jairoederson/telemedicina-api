...
<section class="content-header section-header">
    <div class="row">
        <div class="col-md-12">
            <h1 class="header-title">Registro Apetitoss</h1>
        </div>
    </div>
    ...
    <div class="row" style="margin-right: -30px;margin-left: -30px">
        <div class="panel panel-primary ">
            ...
            <fieldset>
                <div class="col-md-12">
                    <div class="col-md-12">
                        <div id="apetitosSistema" class="panelcambio" style="display: block">
...
<script>
    ...
    var registrarApetitos = "{{ URL::to('admin/registrarApetitos') }}";
