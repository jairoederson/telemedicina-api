...
<!--                            <th>Estado</th>-->
                  ...
                  <div id="pagosEmpresas" class="table-responsive" style="display: none">
                      <table class="table table-bordered width100" id="tablePagosEmpresa" >
                          <thead>
                          <tr class="filters">
                            <th>Id</th>
                            <th>Empresa</th>
                ...
                <div class="row">
                  <ul class="nav nav-tabs tabs-li" style="width: 100%">
                    ...
                    <li class="col-md-6 active">
                      <a href="#pagGeneral" data-toggle="tab" aria-expanded="false">General_<div class="ripple-container"></div></a>
                    </li>
  ...
  <!-- MODAL SECTION END -->
    ...
    <script type="text/javascript" src="{{ asset('assets/js/frontend/admin/pago.js')}}"></script>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            var tableMedicos = $('#tablePagos').DataTable({
              "language": {
        ...
        listarPagoMedico();
        function listarPagoMedico() {
        $.ajax({
            type: 'post',
            url: "{{ URL::to('admin/listarpagosmedicoshistorial') }}",
            dataType: "json",
