<ul id="menu" class="page-sidebar-menu" style="height: 100vh;background-color:white !important;">
    <li {!! (Request::is('admin') ? 'class="active"' : '') !!} style="padding-top: 5px;">
        <a href="{{ route('admin.dashboard') }}" style="font-size: 14px;font-family: 'Ubuntu', sans-serif;">
            <!-- <i class="livicon" data-name="dashboard" data-size="18" data-c="#ffffff" data-hc="#ffffff"
               data-loop="true"></i> -->
            <span class="icon-nav glyphicon glyphicon-home" aria-hidden="true" style="margin-left:7px;"></span>
            <label class="label-nav">Dashboard</label>
        </a>
    </li>


    <li id="menuUsuario" style="padding-top: 5px;color:black;">
        <a href="#" style="font-size: 14px;font-family: 'Ubuntu', sans-serif;">
            <!-- <i class="livicon" data-name="dashboard" data-size="18" data-c="#ffffff" data-hc="#ffffff"
               data-loop="true"></i> -->
            <span class="icon-nav glyphicon glyphicon-user" aria-hidden="true" style="margin-left:7px;"></span>
            <label class="label-nav">Usuarios</label>
        </a>
        <ul class="sub-menu">
            <li >
                <a href="{{ URL::to('admin/usuario/0') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Ver Todos
                </a>
            </li>
            <li >
                <a href="{{ URL::to('admin/registrousuario') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Registrar Nuevo
                </a>
            </li>
     ...
     <li id="menuEspecialidades" style="padding-top: 5px;">
        <a href="#" style="font-size: 14px;font-family: 'Ubuntu', sans-serif;">
            <!-- <i class="livicon" data-name="dashboard" data-size="18" data-c="#ffffff" data-hc="#ffffff"
               data-loop="true"></i> -->
            <span class="icon-nav glyphicon glyphicon-user" aria-hidden="true" style="margin-left:7px;"></span>
            <label class="label-nav">Especialidad</label>
        </a>
        <ul class="sub-menu">
            <li >
                <a href="{{ URL::to('admin/especialidad') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Ver Todos
                </a>
            </li>
            <li >
                <a href="{{ URL::to('admin/registrarespecialidad') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Registrar Nuevo
                </a>
            </li>
    ...
    <li id="menuHistorialMedico" style="padding-top: 5px;">
        <a href="#" style="font-size: 14px;font-family: 'Ubuntu', sans-serif;">
            <!-- <i class="livicon" data-name="dashboard" data-size="18" data-c="#ffffff" data-hc="#ffffff"
               data-loop="true"></i> -->
            <span class="icon-nav glyphicon glyphicon-user" aria-hidden="true" style="margin-left:7px;"></span>
            <label class="label-nav">Historial Medico</label>
        </a>
        <ul class="sub-menu">
            <li >
                <a href="{{  URL::to('admin/prenatal') }}">
                    <!-- <i class="livicon" data-name="help" data-size="18" data-c="#ffffff" data-hc="#ffffff"
                       data-loop="true"></i> -->
                    <span class="icon-nav glyphicon glyphicon-list-alt" aria-hidden="true" style="margin-left:7px"></span>
                    <label class="label-nav">Pre Natal</label>
        
                </a>
            </li>
            <li >
                <a href="{{  URL::to('admin/nacimiento') }}">
                    <!-- <i class="livicon" data-name="help" data-size="18" data-c="#ffffff" data-hc="#ffffff"
                       data-loop="true"></i> -->
                    <span class="icon-nav glyphicon glyphicon-list-alt" aria-hidden="true" style="margin-left:7px"></span>
                    <label class="label-nav">Nacimiento</label>
        
                </a>
            </li>
            <li >
                <a href="{{  URL::to('admin/inmunisaciones') }}">
                    <!-- <i class="livicon" data-name="help" data-size="18" data-c="#ffffff" data-hc="#ffffff"
                       data-loop="true"></i> -->
                    <span class="icon-nav glyphicon glyphicon-list-alt" aria-hidden="true" style="margin-left:7px"></span>
                    <label class="label-nav">Inmunisaciones</label>
        
                </a>
            </li>
            <li >
                <a href="{{  URL::to('admin/habitos') }}">
                    <!-- <i class="livicon" data-name="help" data-size="18" data-c="#ffffff" data-hc="#ffffff"
                       data-loop="true"></i> -->
                    <span class="icon-nav glyphicon glyphicon-list-alt" aria-hidden="true" style="margin-left:7px"></span>
                    <label class="label-nav">Habitos</label>
        
                </a>
            </li>
            <li >
                <a href="{{  URL::to('admin/apetitos') }}">
                    <!-- <i class="livicon" data-name="help" data-size="18" data-c="#ffffff" data-hc="#ffffff"
                       data-loop="true"></i> -->
                    <span class="icon-nav glyphicon glyphicon-list-alt" aria-hidden="true" style="margin-left:7px"></span>
                    <label class="label-nav">Apetitos</label>
        
                </a>
            </li>
            <li >
                <a href="{{  URL::to('admin/orinas') }}">
                    <!-- <i class="livicon" data-name="help" data-size="18" data-c="#ffffff" data-hc="#ffffff"
                       data-loop="true"></i> -->
                    <span class="icon-nav glyphicon glyphicon-list-alt" aria-hidden="true" style="margin-left:7px"></span>
                    <label class="label-nav">Orinas</label>
        
                </a>
            </li>
            <li >
                <a href="{{  URL::to('admin/deposiciones') }}">
                    <!-- <i class="livicon" data-name="help" data-size="18" data-c="#ffffff" data-hc="#ffffff"
                       data-loop="true"></i> -->
                    <span class="icon-nav glyphicon glyphicon-list-alt" aria-hidden="true" style="margin-left:7px"></span>
                    <label class="label-nav">Deposiciones</label>
        
                </a>
            </li>
            <li >
                <a href="{{  URL::to('admin/sed') }}">
                    <!-- <i class="livicon" data-name="help" data-size="18" data-c="#ffffff" data-hc="#ffffff"
                       data-loop="true"></i> -->
                    <span class="icon-nav glyphicon glyphicon-list-alt" aria-hidden="true" style="margin-left:7px"></span>
                    <label class="label-nav">Sed</label>
        
                </a>
            </li>
            <li >
                <a href="{{  URL::to('admin/suenos') }}">
                    <!-- <i class="livicon" data-name="help" data-size="18" data-c="#ffffff" data-hc="#ffffff"
                       data-loop="true"></i> -->
                    <span class="icon-nav glyphicon glyphicon-list-alt" aria-hidden="true" style="margin-left:7px"></span>
                    <label class="label-nav">Sueños</label>
        
                </a>
            </li>
        </ul>
    </li>
    <!--    <li {!! (Request::is('admin/medicos') ? 'class="active"' : '') !!}>
            <a href="{{  URL::to('admin/medicos') }}">
    
                <span class="icon-nav glyphicon glyphicon-check" aria-hidden="true" style="margin-left:7px"></span>
    
                <label class="label-nav title">Médicos</label>
            </a>
        </li>-->
<!--    <li {!! (Request::is('admin/postulantes') ? 'class="active"' : '') !!}>
        <a href="{{  URL::to('admin/postulantes') }}">
         
            <span class="icon-nav glyphicon glyphicon-bookmark" aria-hidden="true" style="margin-left:7px"></span>
            <label class="label-nav">Postulantes</label>

        </a>
    </li>-->
    <!--    <li {!! (Request::is('admin/pacientes') ? 'class="active"' : '') !!}>
            <a href="{{  URL::to('admin/pacientes') }}">
               
                   <span class="icon-nav glyphicon glyphicon-duplicate" aria-hidden="true" style="margin-left:7px"></span>
                   <label class="label-nav">Pacientes</label>
    
            </a>
        </li>-->

    {{-- <li id="menuAsociado" style="padding-top: 5px;">
        <a href="#">
            <!-- <i class="livicon" data-name="dashboard" data-size="18" data-c="#ffffff" data-hc="#ffffff"
               data-loop="true"></i> -->
            <span class="icon-nav glyphicon glyphicon-th-large" aria-hidden="true" style="margin-left:7px"></span>
            <label class="label-nav">Asociados</label>

        </a>
        <ul class="sub-menu">
            <li>
                <a href="{{  URL::to('admin/asociado') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Ver Todos
                </a>
            </li>
    ...
    <li id="menuSintomas">
        <a href="{{  URL::to('admin/sintomas') }}">
            <!-- <i class="livicon" data-name="help" data-size="18" data-c="#ffffff" data-hc="#ffffff"
               data-loop="true"></i> -->
            <span class="icon-nav glyphicon glyphicon-list-alt" aria-hidden="true" style="margin-left:7px"></span>
            <label class="label-nav">Sintomas</label>

        </a>
    </li>

    <li id="menuConsultas">
        <a href="{{  URL::to('admin/consultas') }}">
            <!-- <i class="livicon" data-name="help" data-size="18" data-c="#ffffff" data-hc="#ffffff"
               data-loop="true"></i> -->
            <span class="icon-nav glyphicon glyphicon-list" aria-hidden="true" style="margin-left:7px"></span>
            <label class="label-nav">Consultas</label>

        </a>
    </li>


    <!-- <li id="menuLaboratorios">
        <a href="{{ URL::to('admin/laboratorios') }}">
            <span class="icon-nav glyphicon glyphicon-sound-dolby" aria-hidden="true" style="margin-left:7px"></span>
            <label class="label-nav">Laboratorios</label>
        ...
        <ul class="sub-menu">
            ...
            <li>
                <a href="{{ URL::to('admin/laboratoriosreg') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Registrar Nuevo
                </a>
            </li>
...
<!--    <li {!! (Request::is('admin/recetas') || Request::is('admin/log_viewers/logs')  ? 'class="active"' : '') !!}>
        <a href="{{  URL::to('admin/recetas') }}">
           
            <span class="icon-nav glyphicon glyphicon-list-alt" aria-hidden="true" style="margin-left:7px"></span>
            <label class="label-nav">Recetas</label>           
        </a>
    </li>-->
    ...
    {{-- <li id="menuPagosLiquidaciones">
        <a href="#">
            <!-- <i class="livicon" data-name="medal" data-size="18" data-c="#ffffff" data-hc="#ffffff"
               data-loop="true"></i> -->
            <span class="icon-nav glyphicon glyphicon-duplicate" aria-hidden="true" style="margin-left:7px"></span>

            <label class="label-nav">Pagos y liquidaciones</label>
            <!-- <span class="fa arrow"></span> -->
        </a>
        
        <ul class="sub-menu">
            <li>
                <a href="{{ URL::to('admin/pagosmedico') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Pagos
                </a>
            </li>
            <li>
                <a href="{{ URL::to('admin/liquidaciones') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Liquidaciones
                </a>
            </li>
...
<!--    <li {!! (Request::is('admin/finanzas') || Request::is('admin/log_viewers/logs')  ? 'class="active"' : '') !!}>

        <a href="{{  URL::to('admin/finanzas') }}">
       
            <span class="icon-nav glyphicon glyphicon-piggy-bank" aria-hidden="true" style="margin-left:7px"></span>
            <label class="label-nav">Finanzas</label>
    ...
    {{-- <li id="menuLog">
        ...
        <a href="{{  URL::to('admin/log') }}">
            <!-- <i class="livicon" data-name="help" data-size="18" data-c="#ffffff" data-hc="#ffffff"
               data-loop="true"></i> -->
            <span class="icon-nav glyphicon glyphicon-cog" aria-hidden="true" style="margin-left:7px"></span>
            <label class="label-nav">Log</label>

        </a>
    </li> --}}
    {{-- <li {!! (Request::is('admin/configuracion') || Request::is('admin/log_viewers/logs')  ? 'class="active"' : '') !!}>

        <a href="{{  URL::to('admin/configuracion') }}">
            <!-- <i class="livicon" data-name="help" data-size="18" data-c="#ffffff" data-hc="#ffffff"
               data-loop="true"></i> -->
            <span class="icon-nav glyphicon glyphicon-cog" aria-hidden="true" style="margin-left:7px"></span>
            <label class="label-nav">Configuración</label>
    ...
    {{-- <li id="menuPreguntas">
        <a href="#">
            <!-- <i class="livicon" data-name="medal" data-size="18" data-c="#ffffff" data-hc="#ffffff"
               data-loop="true"></i> -->
            <span class="icon-nav glyphicon glyphicon-question-sign" aria-hidden="true" style="margin-left:7px"></span>

            <label class="label-nav">Preguntas </label>
            <!-- <span class="fa arrow"></span> -->
        </a>
        
        <ul class="sub-menu">
            <li>
                <a href="{{ URL::to('admin/categoriapregunta') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Categoria Preguntas
                </a>
            </li>
            <li>
                <a href="{{ URL::to('admin/subcategoriapregunta') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Subcategoria Preguntas
                </a>
            </li>
            <li>
                <a href="{{ URL::to('admin/pregunta') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Lista de Preguntas
                </a>
            </li>
    ...
    <!-- <li {!! ( Request::is('admin/laravel_chart') || Request::is('admin/database_chart') ? 'class="active"' : '') !!}>
        <a href="#">
            <i class="livicon" data-name="barchart" data-size="18" data-c="#418BCA" data-hc="#418BCA"
               data-loop="true"></i>
            <span class="title">Administrar Admision</span>
            <span class="fa arrow"></span>
        </a>
        <ul class="sub-menu">
    ...
    <!-- <li {!! (Request::is('admin/form_builder') || Request::is('admin/form_builder2') || Request::is('admin/buttonbuilder') || Request::is('admin/gridmanager') ? 'class="active"' : '') !!}>
        <a href="#">
            <i class="livicon" data-name="wrench" data-size="18" data-c="#6CC66C" data-hc="#6CC66C"
               data-loop="true"></i>
            <span class="title">Administrar Consultas</span>
            <span class="fa arrow"></span>
        </a>
        <ul class="sub-menu">
...
display:block;
">
    <a> <img _ngcontent-aka-c0="" alt="logo" src="assets/images/app_image.png" style="width: 100%;"></a>
    <a> <img _ngcontent-aka-c0="" alt="" src="assets/images/google_play.png" style="max-width: 50%"></a>
    <a> <img _ngcontent-aka-c0="" alt="" src="assets/images/store.png" style="max-width: 50%"></a>
