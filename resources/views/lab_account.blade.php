        ...
        <div class="col s12 ">
          ...
          <div class="row center padding-top-element">
            ...
            <div class="col s3 center">
              ...
              <a id="guardar" href="#updateAccount" onclick="updateAccount(); guardar()" style="display:none; width:150;" class="modal-trigger waves-effect btn button-green format">Guardar Cambios</a>
      ...
      <div class="">
        <form class="col s12" name="form_doctor_pass" ng-app="app_doctor_pass" ng-controller="validateCtrl">
              ...
              <div class="row padding-top-element center">
                <br>
                <a href="#updatePassword" onclick="updatePassword()" class="format modal-trigger waves-effect btn button-green format">Guardar Cambios</a>
              </div>
            </form>
      </div>
   </div>
