...
<body>
    ...
    <div class="hgroup">
        ...
        <h2>Al parecer la págiana que esta buscando no existe</h2>
        <a href="{{ route('home') }}">
            <button type="button" class="btn button-alignment" style="background-color: #868686">Volver a Inicio</button>
        </a>
    </div>
    <!-- global js -->
