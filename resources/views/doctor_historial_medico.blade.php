...
@section('content')
<div id="historial-medico" class="section-historial-medico">
  <div class="row background-white">
      ...
      <div class="cuerpo-historial" style="padding-left: 40px;padding-right: 50px; text-align: justify">
        <ul class="collapsible" data-collapsible="accordion">
          <li>
            <div class="collapsible-header"> <b>DATOS FILIATORIOS</b></div>
          ...
          <li>
            <div class="collapsible-header"><b>  ANTECEDENTES HEREDOFAMILIARES</b> </div>
            <div class="collapsible-body">
              <div class="row">
                <div class="col s2">
                  <label>
          ...
          <li>
            <div class="collapsible-header"> <b>ANTECEDENTES PERSONALES</b> </div>
            <div class="collapsible-body">
              <div class="border-bottom">
...
function mostrar(){
  ...
  document.getElementById("historial-medico").style.paddingLeft = '4%';
}
function ocultar(){
  ...
  document.getElementById("historial-medico").style.paddingLeft = '2%';
}
</script>
