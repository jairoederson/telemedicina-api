        ...
        <div class="row padding-top-element">
          <div class="col s12 m12">
              <div class="dataTables_wrapper form-inline dt-material">
                ...
                <table id="tableLabSecHistorial" class="bordered" style="width: 100% !important">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>CODIGO</th>
...
<!-- MODAL -->
<div id="verHistorialMedico" class="modal">

  <div class="modal-cabecera">
    <div class="row">
      <div class="col s6">
        <div class="left title-modal" style="padding-left: 10px;">
          <h5 class="color-white" style="font-size: 20px;"> <b>Historial Médico</b> </h5>
        </div>
      </div>
      <div class="col s6">
