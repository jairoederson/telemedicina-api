...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/frontend/lab/lab.css') }}">
              ...
              <ul id="nav-mobile" class="right hide-on-med-and-down" style="">
                ...
                <li class="nav-header">
                  ...
                  <ul id='dropdown1' class='dropdown-content' style="margin-top:65px; margin-left: 20px;border: 1px solid #d6d2d2">
                    <li><a href="{{ URL::to('lab-account') }}"><i class="material-icons" style="margin-right: 10px !important">account_circle</i>Mi Cuenta</a></li>
                    <li class="divider"></li>
                    <li><a href="{{ URL::to('lab-new-analisis') }}"><i class="material-icons" style="margin-right: 10px !important">add_circle</i>Nuevo Análisis Méd.</a></li>
                    <li><a href="{{ URL::to('lab-analisis') }}"><i class="material-icons" style="margin-right: 10px !important">note_add</i>Análisis Médico</a></li>
                    <!-- <li><a href="{{ URL::to('doctor-consulta') }}"><i class="material-icons">assignment_turned_in</i>Historial Medico</a></li> -->
                    <li><a href="{{ URL::to('lab-historial') }}"><i class="material-icons" style="margin-right: 10px !important">assignment</i>Historial Médico</a></li>
                    <!-- <li><a href="{{ URL::to('doctor-ingreso') }}"><i class="material-icons">monetization_on</i>Ayuda</a></li> -->
                    <li><a href="{{ URL::to('lab-ayuda') }}"><i class="material-icons" style="margin-right: 10px !important">live_help</i>Ayuda</a></li>
                    <li class="divider"></li>
              ...
              <ul class="side-nav fixed" style="transform: translateX(0px);display: block;background-color: #e22715; bottom:0px !important; width: 100%; margin-top: 0%; position: relative">
                <li class="no-padding">
                  <ul class="collapsible collapsible-accordion">
                    <li id="cuentaNav" class="bold" {!! (Request::is('lab-account') ? 'class="active"' : '') !!}>
                      <a href="{{ URL::to('lab-account') }}" class="collapsible-header  waves-effect waves-teal" style="color: white; font-family: 'Ubuntu', sans-serif;">
                        <i class="menu material-icons white-text text-darken-4">account_circle</i>
                        Mi Cuenta
                      </a>
                    </li>
                    <li id="nuevoAnalisisNav" class="bold" {!! (Request::is('lab-new-analisis') ? 'class="active"' : '') !!}>
                      <a href="{{ URL::to('lab-new-analisis') }}" class="collapsible-header  waves-effect waves-teal" style="color: white; margin-bottom: 0px !important; font-family: 'Ubuntu', sans-serif;">
                        <i class="material-icons white-text text-darken-4">add_circle</i>
                        Nuevo Análisis Médico
                      </a>
                    </li>
                    <li id="analisisNav" class="bold" {!! (Request::is('lab-analisis') ? 'class="active"' : '') !!}>
                      <a href="{{ URL::to('lab-analisis') }}" class="collapsible-header  waves-effect waves-teal" style="color: white; margin-bottom: 0px !important; font-family: 'Ubuntu', sans-serif;">
                        <i class="material-icons white-text text-darken-4">note_add</i>
                        Análisis Médico
                      </a>
                    </li>
                    <li id="historialNav" class="bold" {!! (Request::is('lab-historial') ? 'class="active"' : '') !!}>
                      <a href="{{ URL::to('lab-historial') }}" class="collapsible-header  waves-effect waves-teal" style="color: white; font-family: 'Ubuntu', sans-serif;">
                        <i class="menu material-icons white-text text-darken-4">assignment</i>
                        Historial Médico
                      </a>
                    </li>

                    <li id="ayudaNav" class="bold" {!! (Request::is('lab-a') ? 'class="active"' : '') !!}>
                      <a href="{{ URL::to('lab-ayuda') }}" class="collapsible-header  waves-effect waves-teal" style="color: white; margin-bottom: 0px !important; font-family: 'Ubuntu', sans-serif;">
              ...
              <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                  <li id="navCuenta" class="bold menu-aside">
                    <a href="{{ URL::to('lab-account') }}" data-position="right" data-delay="50" data-tooltip="Mi Cuenta" class="tooltipped collapsible-header  waves-effect waves-teal" style="color: white; margin-bottom: 0px !important; font-family: 'Ubuntu', sans-serif;">
                      <i class="icon-margin-left material-icons white-text text-darken-4">account_circle</i>
                    </a>
                  </li>
                  <li id="navNuevoAnalisis" class="bold menu-aside">
                    <a href="{{ URL::to('lab-new-analisis') }}" data-position="right" data-delay="50" data-tooltip="Nuevo Análisis clínico" class="tooltipped collapsible-header  waves-effect waves-teal" style="color: white; margin-bottom: 0px !important; font-family: 'Ubuntu', sans-serif;">
                      <i class="icon-margin-left material-icons white-text text-darken-4">add_circle</i>
                    </a>
                  </li>
                  <li id="navAnalisis" class="bold menu-aside">
                    <a href="{{ URL::to('lab-analisis') }}" data-position="right" data-delay="50" data-tooltip="Análisis clínico" class="tooltipped collapsible-header  waves-effect waves-teal" style="color: white; margin-bottom: 0px !important; font-family: 'Ubuntu', sans-serif;">
                  ...
                  <li id="navHistorialMedico" class="bold menu-aside">
                    <a href="{{ URL::to('lab-historial') }}" data-position="right" data-delay="50" data-tooltip="Historial Médico" class="tooltipped collapsible-header  waves-effect waves-teal" style="color: white; margin-bottom: 0px !important; font-family: 'Ubuntu', sans-serif;">
                      <i class="icon-margin-left material-icons white-text text-darken-4">assignment</i>
                    </a>
                  </li>

                  <li id="navAyuda" class="bold menu-aside">
                    <a href="{{ URL::to('lab-ayuda') }}" data-position="right" data-delay="50" data-tooltip="Ayuda" class="tooltipped collapsible-header waves-effect waves-teal" style="color: white; font-family: 'Ubuntu', sans-serif;">
    ...
    <script type="text/javascript" src="{{ asset('assets/js/frontend/lab/lab.js') }}"></script>
