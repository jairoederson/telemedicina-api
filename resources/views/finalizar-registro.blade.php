    ...
    <div class="row">
        <div class="box animation flipInX">
          <a href="/">
            ...
            <h4 class="text-center" style="color: #9f9f9f">Estás a un paso de finalizar tu registro</h4>
            <p for="">Obtendras tu monedero del ahorro y precios exclusivos. Selecciona los siguientes datos y presiona el boton "Finalizar Registro"</p>
            <!-- Notifications -->
            <div id="notific">
            ...
            <form action="{{ route('register') }}" method="POST" id="reg_form">
                ...
                <div class="group form-group {{ $errors->first('name', 'has-error') }}">
                  ...
                  <span class="bar"></span>
                  <label class="material">Numero de documento</label>
                ...
                <div class="group form-group">
                  <input type="date" name="name" value="{!! old('name') !!}" required style="padding-right:0px">
                </div>
