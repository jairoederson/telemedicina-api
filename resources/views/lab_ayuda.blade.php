              ...
              <div id="">
                <div class="row">
                  <ul class="collapsible" data-collapsible="accordion">
                    ...
                    <li>
                      <div onclick="preguntasCategoria('categoria2')" class="collapsible-header"><i class="material-icons icon-color">assignment</i>Historial Médico</div>
                      <!-- <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div> -->
                    </li>
                    <li>
                      <div onclick="preguntasCategoria('categoria3')" class="collapsible-header"><i class="material-icons icon-color">note_add</i>Análisis Médico</div>
                        <!-- <div class="collapsible-body">
                            <span>
                            Lorem ipsum dolor sit amet.Lorem ipsum dolor sit amet.Lorem ipsum dolor sit amet.
                            Lorem ipsum dolor sit amet.Lorem ipsum dolor sit amet.Lorem ipsum dolor sit amet.
