...
<body style="background-color: #e22715">
    <div class="container-fluid">
        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-offset-1 col-xs-10 middle" style="padding-top: 0px !important">
            <div class="error-container">
                <div class="error-main" style="color: white">
                    <h1>
                    ...
                    <h3>
                        ...
                        <br>Hubo un error. Por favor, inténtelo de nuevo más tarde.
                    </h3>
                        <a href="{{ route('home') }}" class="btn" style="background-color: #868686">Inicio</a>
                    <br>
                </div>
            </div>
        </div>
