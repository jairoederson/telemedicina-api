...
<div id="pass" class="" style="height: 100%; width:100%; padding: 3% 4% 5% 4%; background-color: #fafafa">
    <div class="row card" style="">
      <div class="col s12 m12">
        ...
        <div class="card">
          <div class="card-form">
            <form class="col s12" name="form_pacciente_pass" ng-app="app_paciente_pass" ng-controller="validateCtrl">
              ...
              <div class="row">
                 <div class="input-field col s11">
                   ...
                   <input id="password" name="oldPass" ng-minlength="8" ng-pattern="/^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,}$/" ng-model="oldPass" type="password" class="validate" required>
                   <label for="password">Contraseña Actual</label>
                   <span style="color:red" ng-show="form_pacciente_pass.oldPass.$dirty && form_pacciente_pass.oldPass.$invalid">
                     <!-- <span ng-show="form_pacciente_pass.oldPass.$error.required">Antigua contraseña requerida.</span>
                     <span ng-show="form_pacciente_pass.oldPass.$error.pattern">Use los caracteres mencionados.</span>
                     <span ng-show="form_pacciente_pass.oldPass.$error.minlength">Minimo 8 caracteres.</span>
                     <span ng-show="form_pacciente_pass.oldPass.$error.password">Contraseña inválida.</span> -->
                   </span>
                 </div>
                 <div class="col s1">
              ...
              <div class="row">
               <div class="input-field col s11">
                 ...
                 <input id="passwordnew" ng-minlength="8" name="newPass" ng-pattern="/^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,}$/" ng-model="newPass" type="password" class="validate" required>
                 <label for="email">Nueva Contraseña</label>
                 <span style="color:red" ng-show="form_pacciente_pass.newPass.$dirty && form_pacciente_pass.newPass.$invalid">
                   <span ng-show="form_pacciente_pass.newPass.$error.required">Nueva contraseña requerida.</span>
                   <span ng-show="form_pacciente_pass.oldPass.$error.minlength">Minimo 8 caracteres.</span>
                   <span ng-show="form_pacciente_pass.newPass.$error.pattern">Use los caracteres mencionados:</span>
                   <span ng-show="form_pacciente_pass.newPass.$error.password">Contraseña inválida.</span>
                 </span>
              ...
              <div class="row">
                 <div class="input-field col s11">
                   <i class="material-icons prefix">lock</i>
                   <input id="passwordnewrep" ng-minlength="8" name="newPassRep" ng-pattern="/^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,}$/" ng-model="newPassRep" type="password" class="validate" required>
                   <label for="password">Confirmar Contraseña</label>
                   <span style="color:red" ng-show="form_pacciente_pass.newPassRep.$dirty && form_pacciente_pass.newPassRep.$invalid">
                     <span ng-show="form_pacciente_pass.newPassRep.$error.required">Nueva contraseña requerida.</span>
                     <span ng-show="form_pacciente_pass.oldPass.$error.minlength">Minimo 8 caracteres.</span>
                     <span ng-show="form_pacciente_pass.newPassRep.$error.pattern">Use los caracteres mencionados:</span>
                     <span ng-show="form_pacciente_pass.newPassRep.$error.password">Contraseña inválida.</span>
                   </span>
                   <span class="span-medidor">8 caracteres, 1 mayúscula, 1 carácter no alfanumérico</span>
                 </div>
                 <div class="col s1">
              ...
              <div class="row" style="text-align: right">
                <a class="waves-effect btn" style=" background-color: #868686; width: 100%">GUARDAR CAMBIOS</a>
              </div>
            </form>
          </div>
        </div>
