    ...
    <div class="breadcum" style="background-color: #FFCC80">
        <div class="container">
            ...
            <div class="pull-right">
                <i class="livicon icon3" data-name="users" data-size="20" data-loop="true" data-c="#3d3d3d" data-hc="#3d3d3d"></i> Acerca De Nosotros
            </div>
        </div>
    </div>
    @stop
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-7 col-sm-12 wow bounceInLeft" data-wow-duration="5s">
                <h2><label>Bienvenido a Humanidad Sur</label></h2>
                <p>
        ...
        <div class="row">
            <div class="text-center">
                <h3 class="border-success"><span class="heading_border bg-success" >Servicios</span></h3>
            </div>
            <!-- left Section Start -->
            <div class="col-md-12 col-sm-12">
                ...
                <div class="col-sm-3 col-md-3 wow zoomIn" data-wow-duration="3s">
                    <div class="box">
                        ...
                        <div class="info">
                            <h3 class="success text-center">Mensajeria y Chat</h3>
                            ...
                            <div class="text-right success"><a href="#">Read more</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-3 col-md-3 wow zoomIn" data-wow-duration="3s">
                    <div class="box">
                        <div class="box-icon box-icon2">
                            <i class="livicon icon1" data-name="user" data-size="55" data-loop="true" data-c="#f89a14" data-hc="#f89a14"></i>
                        </div>
                        <div class="info">
                            <h3 class="warning text-center">Atencion al Cliente</h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti atque, tenetur quam aspernatur corporis at explicabo nulla dolore necessitatibus doloremque exercitationem sequi dolorem architecto perferendis quas aperiam debitis dolor soluta!</p>
                            <div class="text-right warning"><a href="#">Read more</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="text-center">
                <h3 class="border-warning"><span class="heading_border bg-warning" >Nuestro Equipo</span></h3>
            </div>
            ...
            <div class="col-md-3 col-sm-5 col-xs-10 profile wow zoomIn" data-wow-duration="3.5s">
                <div class="thumbnail bg-white  text-center">
                    <img src="{{ asset('assets/images/doctor1.jpg') }}" alt="team-image" class="img-responsive">
                    <div class="caption">
                        <b>John Doe</b>
                        <br /> Founder &amp; Partner
                        <br />
            ...
            <div class="col-md-3 col-sm-5 col-xs-10 profile wow zoomIn" data-wow-duration="3s" data-wow-delay="0.8s">
                <div class="thumbnail bg-white text-center">
                    <img src="{{ asset('assets/images/doctor3.jpg') }}" alt="team-image">
                    <div class="caption">
