...
<div class='text-center'>
  <button title='Ver' data-toggle='modal' data-target='#verLaboratorio' class='btn-crud btn' style='background-color: #868686; margin-right: 0px'>
      ...
      var tableLaboratorios = $('#tableLaboratorio').DataTable({
        ...
        "data": [
          [
            ...
            "555858",
            "Glucosa",
            "<a href='' data-toggle='modal' data-target='#verPacienteLaboratorio'>Sebastian Morgan</a>",
            "<a href='' data-toggle='modal' data-target='#verMedicoLaboratorio'>Esteban Z.</a>",
            "12/05/2017",
            acciones
          ],
        ]
