...
$(function () {
  ...
  var tableprenatal = $("#tableprenatal").DataTable({
    language: {
...
function listarprenatal() {
  $.ajax({
    type: "post",
    url: urllistarprenatal,
    dataType: "json",
    data: { _token: token },
    ...
    .done(function (dataRpta) {
      ...
      $("#tableprenatal").DataTable().clear().draw();
      jQuery.each(dataRpta, function (i, val) {
        val.acciones =
          `
                  <div class='text-center'>
                    
              <button title='Editar' onclick="location.href='/admin/actualizarprenatal/` +
          val.id +
        ...
        $("#tableprenatal").DataTable().row.add(val).draw();
      });
    })
...
function eliminarprenatal(id) {
  $.ajax({
    type: "post",
    url: eliminarprenatal,
    dataType: "json",
    data: { id_prenatal: id, _token: token },
    beforeSend: function (xhr) {
      //alert(id);
    },
  })
